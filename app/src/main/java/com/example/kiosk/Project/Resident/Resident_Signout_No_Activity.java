...
public class Resident_Signout_No_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resident_singout_no);
        ctx = Resident_Signout_No_Activity.this;
                                ...
                                if (flag.equalsIgnoreCase("true")) {
                                    ...
                                    if (agency_responce.getData() != null) {
                                        ...
                                        agency_data_list = agency_responce.getData();
                                            ...
                                            Intent i = new Intent(ctx, Resident_List_Signout_Activity.class);
