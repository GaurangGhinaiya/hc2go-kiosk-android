...
public class FG_EpartmentDetails_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = FG_EpartmentDetails_Activity.this;
                                ...
                                if (flag.equalsIgnoreCase("true")) {
                                    ...
                                    if (agency_responce.getData() != null) {
                                        ...
                                        if (agency_data_list.size() == 1) {
                                            ...
                                            Intent i = new Intent(ctx, FG_PatientList_Activity.class);
                                            Bundle bundle = new Bundle();
                                            bundle.putString("arraylist_member", new Gson().toJson(agency_data_list));
                                            i.putExtras(bundle);
                                            startActivity(i);
