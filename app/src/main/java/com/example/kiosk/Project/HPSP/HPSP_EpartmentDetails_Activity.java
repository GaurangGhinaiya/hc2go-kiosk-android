...
public class HPSP_EpartmentDetails_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = HPSP_EpartmentDetails_Activity.this;
                            ...
                            try {
                                ...
                                if (flag.equalsIgnoreCase("true")) {
                                    ...
                                    if (agency_responce.getData() != null) {
                                        ...
                                        if (agency_data_list.size() == 1) {
                                            Intent i = new Intent(ctx, HPSP_VisitElse_Activity.class);
                                            Bundle bundle = new Bundle();
                                            bundle.putString("arraylist_member", new Gson().toJson(agency_data_list));
                                            i.putExtras(bundle);
                                            startActivity(i);
                                        } else if (agency_data_list.size() > 1) {
                                            Intent i = new Intent(ctx, HPSP_PatientList_Activity.class);
                                            Bundle bundle = new Bundle();
                                            bundle.putString("arraylist_member", new Gson().toJson(agency_data_list));
                                            i.putExtras(bundle);
                                            startActivity(i);
