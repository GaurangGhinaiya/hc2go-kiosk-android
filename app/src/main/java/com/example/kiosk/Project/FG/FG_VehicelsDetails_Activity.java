...
public class FG_VehicelsDetails_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = FG_VehicelsDetails_Activity.this;
        ...
        ll_Next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ctx, FG_visitInformation_Activity.class);
